...
export default class CategorySorter extends Component {
	...
	sortAndInject() {
		...
		if (!originalWrapper) {
			// On mobile, the table doesn't exist - just exit gracefully
			// and let the default mobile view render
			console.log('📱 Table not found (likely mobile view) - skipping grouping');
			return;
		}
